<div class="content-cats">
	<ul>
		...
		<?php } elseif( in_category( 'wp-late-night' ) || in_category( 'roundtable' ) || in_category( 'theme-show' ) || in_category( 'the-wpcandy-show' ) || in_category( 'the-sweet-plugin' ) || in_category( 'first-taste' ) ) { ?>
