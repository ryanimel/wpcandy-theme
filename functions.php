...
function wpcandy_theme_setup() {
	 ...
	 * If you're building a theme based on WPCandy Theme, use a find and replace
	 * to change 'wpcandy_theme' to the name of your theme in all the template files
	 */
	...
	register_nav_menus( array(
		'primary' => __( 'Primary Menu', 'wpcandy_theme' ),
	) );
