...
<?php get_template_part( 'parts/header', 'quarterly' ); ?>

		<div id="main" role="main"<?php if(in_category('Videos') && is_single()) { ?> class="category-videos"<?php } ?>>
			...
			<div class="wrap">
				...
				<div id="content" class="column-8">
					...
					<div id="hfeed">
						...
						<?php get_template_part( 'parts/loop', 'quarterly' ); ?>
...
<?php get_template_part( 'parts/footer', 'quarterly' ); ?>