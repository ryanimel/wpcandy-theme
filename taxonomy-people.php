...
get_template_part( 'header' ); ?>
				...
				<div id="content" class="column-8">
					...
					<?php 
					$thetax = get_the_terms( $post->ID , 'people' );
					...
					while ( $tax_query->have_posts() ) : $tax_query->the_post(); ?>
						...
						<div class="archive-info-desc">
							...
							<?php echo get_the_term_list( $post->ID, 'companies', '<p class="archive-meta"><strong>Related</strong>: ', ', ', '</p>' ); ?>
					...
					wp_reset_postdata(); ?>
						...
						<?php /* 
						<p id="archive-rss-link"><a href="<?php echo get_term_link( $thetax_id, 'people' ); ?>/feed"><?php single_cat_title(); ?>&rsquo;s post feed</a></p>
						*/ ?>
