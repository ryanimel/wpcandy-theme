...
do_action( 'sidebar_before' ); ?>
				...
				<div id="sidebar" class="column-4 last">
					...
					<aside role="complementary">
						...
						<section>
							<a href="http://phxwordcamp.com/" title="WordCamp Phoenix"><img src="<?php bloginfo('stylesheet_directory'); ?>/library/images/content/wordcampphx-small.png" alt="WordCamp Phoenix" /></a>
							<h3 class="widget-title">What the heck is WordCamp Phoenix?</h3>
							<p>WordCamp Phoenix is a multi-day WordPress event that takes place all over the greater Phoenix in Arizona. Over 600 people will attend the event in 2011.</p>
						</section>
