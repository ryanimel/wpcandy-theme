<?php ?>
							...
							<div class="content-cats">
								<ul>
									...
									<?php } elseif( in_category( 'theme-show' ) || in_category( 'community-interviews' ) || in_category( 'aftertaste' ) || in_category( 'wp-late-night' ) || in_category( 'the-wpcandy-show' ) || in_category( 'the-sweet-plugin' ) || in_category( 'first-taste' ) || in_category( 'pressbits' ) || in_category( 'roundtable' ) ) { ?>
