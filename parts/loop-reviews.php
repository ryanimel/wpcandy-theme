...
if ( have_posts() ) : ?>
	...
	<?php do_action( 'loop_open' ); ?>
			...
			<div id="hfeed">
				...
				<h1 class="page-title">WordPress Reviews</h1>
				<?php echo category_description(); ?>
				<div class="section-rss">
					<p><a href="http://feeds.feedburner.com/wpcandyreviews" title="Subscribe to the WordPress reviews by RSS">Subscribe to our reviews by RSS</a></p>
				</div><!-- .section-rss -->
