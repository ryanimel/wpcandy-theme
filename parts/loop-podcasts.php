...
if ( have_posts() ) : ?>
	...
	<?php do_action( 'loop_open' ); ?>
			...
			<div id="hfeed">
				...
				<h1 class="page-title">WPCandy Podcast</h1>
				<?php echo category_description(); ?>
				<div class="section-rss">
					<p><a href="http://feeds.feedburner.com/wpcandypodcast" title="Subscribe to the WPCandy WordPress Podcast by RSS">Subscribe to our podcast by RSS</a></p>
				</div><!-- .section-rss -->
