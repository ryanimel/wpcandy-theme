...
if ( have_posts() ) : ?>
	...
	<?php do_action( 'loop_open' ); ?>
			...
			<div id="hfeed">
				...
				<h1 class="page-title">WordPress Tutorials</h1>
				<?php echo category_description(); ?>
				<div class="section-rss">
					<p><a href="http://feeds.feedburner.com/wpcandytutorials" title="Subscribe to WordPress tutorials by RSS">Subscribe to tutorials by RSS</a></p>
				</div><!-- .section-rss -->
