...
if ( have_posts() ) : ?>
	...
	<?php do_action( 'loop_open' ); ?>
			...
			<div id="hfeed">
				...
				<h1 class="page-title">WordPress Editorials</h1>
				<?php echo category_description(); ?>
				<div class="section-rss">
					<p><a href="http://feeds.feedburner.com/wpcandyeditorials" title="Subscribe to WordPress editorials by RSS">Subscribe to editorials by RSS</a></p>
				</div><!-- .section-rss -->
