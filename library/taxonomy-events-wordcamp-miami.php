...
get_template_part( 'header' ); ?>
				...
				<h1 class="page-title">WordCamp Miami</h1>
				<?php echo category_description(); ?>
				<div class="section-rss">
					<p><a href="http://feeds.feedburner.com/wpcandymiami" title="Subscribe to coverage of WordCamp Miami">Subscribe to coverage of WordCamp Miami by RSS</a></p>
				</div><!-- .section-rss -->
				...
				<?php get_template_part( 'sidebar', 'miami' ); ?>
